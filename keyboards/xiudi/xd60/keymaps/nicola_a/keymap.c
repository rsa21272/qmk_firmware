...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_F1] = LAYOUT_60_ansi_split_space_bs_rshift(
    ...
    KC_CAPS, NC_ANSI, NC_JIS,  NC_APPL, NC_WIN,  _______, _______, _______, KC_PSCR, KC_SCROLL_LOCK, KC_PAUS, KC_UP,   _______, _______,
  ...
  [_F2] = LAYOUT_60_ansi_split_space_bs_rshift(
    _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_INS,  KC_DEL,
    KC_CAPS, NC_ANSI, NC_JIS,  NC_APPL, NC_WIN,  _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_PSCR, _______, KC_PAUS, _______,
